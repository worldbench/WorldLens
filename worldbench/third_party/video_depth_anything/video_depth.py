...
from .utils import compute_scale_and_shift, get_interpolate_frames
...
class VideoDepthAnything(nn.Module):
    ...
    def infer_video_depth(self, frames, target_fps, input_size=518, target_size=(224,400), device='cuda', fp32=False):
        ...
        for i, depth in enumerate(depth_list):
            depth_list[i] = cv2.resize(depth, (target_size[1], target_size[0]), interpolation=cv2.INTER_NEAREST)
