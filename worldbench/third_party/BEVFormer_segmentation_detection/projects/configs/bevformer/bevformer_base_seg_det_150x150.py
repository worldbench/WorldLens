...
#
plugin = True
plugin_dir = 'worldbench/third_party/BEVFormer_segmentation_detection/projects/mmdet3d_plugin'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + '../nuscenes_mmdet3d_2/nuscenes_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             grid_conf=grid_conf,
             ann_file=data_root + '../nuscenes_mmdet3d_2/nuscenes_infos_temporal_val.pkl',
