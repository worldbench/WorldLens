...
from mmdet3d100rc6.apis import (convert_SyncBN, inference_detector,
                          inference_mono_3d_detector,
                          inference_multi_modality_detector,
                          inference_segmentor, init_model, show_result_meshlab,
                          single_gpu_test)
from mmdet3d100rc6.core import Box3DMode
from mmdet3d100rc6.core.bbox import (CameraInstance3DBoxes, DepthInstance3DBoxes,
                               LiDARInstance3DBoxes)
from mmdet3d100rc6.datasets import build_dataloader, build_dataset
...
def _get_config_directory():
    ...
    try:
        ...
        import mmdet3d100rc6
        repo_dpath = dirname(dirname(mmdet3d100rc6.__file__))
