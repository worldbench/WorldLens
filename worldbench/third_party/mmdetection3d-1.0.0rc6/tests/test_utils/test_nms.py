...
def test_circle_nms():
    from mmdet3d100rc6.core.post_processing import circle_nms
...
def test_nms_bev():
    from mmdet3d100rc6.core.post_processing import nms_bev
...
def test_nms_normal_bev():
    from mmdet3d100rc6.core.post_processing import nms_normal_bev
