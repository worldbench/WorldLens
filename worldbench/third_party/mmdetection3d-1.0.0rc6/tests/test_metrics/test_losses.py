...
from mmdet3d100rc6.models.builder import build_loss


def test_chamfer_disrance():
    from mmdet3d100rc6.models.losses import ChamferDistance, chamfer_distance
...
def test_paconv_regularization_loss():
    from mmdet3d100rc6.models.losses import PAConvRegularizationLoss
    from mmdet3d100rc6.ops import PAConv, PAConvCUDA
...
def test_uncertain_smooth_l1_loss():
    from mmdet3d100rc6.models.losses import UncertainL1Loss, UncertainSmoothL1Loss
...
def test_multibin_loss():
    from mmdet3d100rc6.models.losses import MultiBinLoss
...
def test_axis_aligned_iou_loss():
    from mmdet3d100rc6.models.losses import AxisAlignedIoULoss
...
def test_rotated_iou_3d_loss():
    ...
    from mmdet3d100rc6.models.losses import RotatedIoU3DLoss
