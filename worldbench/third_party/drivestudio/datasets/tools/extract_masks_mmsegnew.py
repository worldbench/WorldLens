...
if __name__ == "__main__":
    ...
    for scene_i, scene_id in enumerate(tqdm(scene_ids_list, f'Extracting Masks ...')):
        ...
        results = inference_mmseg(flist, inferenecer)
        for i, fpath in enumerate(tqdm(flist, f'scene[{scene_id}]')):
            ...
            result = results[i]
            mask = result.astype(np.uint8)   # NOTE: in the settings of "cityscapes", there are 19 classes at most.
