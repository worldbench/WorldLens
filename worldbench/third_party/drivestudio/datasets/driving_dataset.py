...
class DrivingDataset(SceneDataset):
    ...
    def get_novel_render_traj(
        ...
        Args:
            traj_types: List[str]
                ...
                - "lateral_offset": Shift the reference trajectory laterally by a fixed offset
            target_frames: int
    ...
    def prepare_novel_view_render_data(self, traj: torch.Tensor, cam_id: int = None) -> list:
            ...
            return self.pixel_source.prepare_novel_view_render_data(self.type, traj, cam_id)
