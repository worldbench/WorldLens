...
if __name__ == "__main__":
    ...
    if (args.dataset != 'nuscenes' and args.dataset != 'nuscenes_gen') and args.interpolate_N > 0:
    ...
    elif args.dataset == "nuscenes_gen":
        from datasets.nuscenes_gen.nuscenes_preprocess import NuScenesProcessor
