...
dvr = load("dvr", sources=["worldbench/third_party/SparseOcc/lib/dvr/dvr.cpp", "worldbench/third_party/SparseOcc/lib/dvr/dvr.cu"], verbose=True, extra_cuda_cflags=['-allow-unsupported-compiler'])
